...
//        단, 이렇게 하면 더 이상 scanf/printf/puts/getchar/putchar 등 C의 입출력 방식을 사용하면 안 된다. Java를 사용하고 있다면, 
...
namespace Baekjoon
{
    class Baekjoon15552
    {
        static void Main(string[] args)
        {
            ...
            // 시간 제한에 걸리지 않게 하려면, 일반 문자열이 아닌 StringBuilder을 사용해야 함.
            ...
            // A와 B를 입력받아 n이라는 배열에 저장하고, 더해서 num에 저장, 그 후 answer 변수에 전부 저장해 출력
        }
    }
}